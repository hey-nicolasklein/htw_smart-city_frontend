...
final String topicWorkerHistory = 'data/Gruppe4/frontend/worker_history';
final String topicSensorHistory = 'data/Gruppe4/frontend/sensor_history';
final String topicFrontendDaten = 'data/Gruppe4/frontend/daten';

/*
Messages mqttEmulator
 */
const String WRONG_ARGUMENT = 'MQTTEmulator: unkown argument,'
    'use umgebungsdaten, sensor, historyWorker or historySensor';
